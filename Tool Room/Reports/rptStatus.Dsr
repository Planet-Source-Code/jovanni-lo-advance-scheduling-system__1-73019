VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptStatus 
   Bindings        =   "rptStatus.dsx":0000
   Caption         =   "System Reports"
   ClientHeight    =   8025
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   13110
   Icon            =   "rptStatus.dsx":0018
   MDIChild        =   -1  'True
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item2 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         ForeColor       =   4210752
         BackColor       =   12640511
         Object.Caption         =   "Display items by Item Category with in this year."
      EndProperty
      ItemType3       =   3
      ...
      BeginProperty Item6 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         EndProperty
         ForeColor       =   4210752
         Object.Caption         =   "ASIAN COLLEGE OF SCIENCE   AND  TECHNOLOGY"
      EndProperty
      ItemType7       =   7
      ...
      BeginProperty Item11 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         EndProperty
         ForeColor       =   4210752
         Object.Caption         =   "Success Starts Here !"
      EndProperty
      ItemType12      =   3
      BeginProperty Item12 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         EndProperty
         ForeColor       =   4210752
         Object.Caption         =   "Items by Status"
      EndProperty
   EndProperty
   SectionCode1    =   2
   ...
   BeginProperty Section2 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item19 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         EndProperty
         ForeColor       =   16777215
         Object.Caption         =   "Included on Transactions:"
      EndProperty
      ItemType20      =   4
   ...
   EndProperty
End
Attribute VB_Name = "rptStatus"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub DataReport_Initialize()
RunSql "Select * from tblAccountProfile where id = '" & UserId & "'"
With Rs
    rptStatus.Sections("ReportHeader").Controls("lblUserName").Caption = StrConv(.Fields!fname & " " & Left(.Fields!mname, 1) & ". " & .Fields!lname, vbProperCase)
End With
rptStatus.Sections("PageFooter").Controls("lblApp").Caption = App.ProductName & " v" & App.Major & "." & App.Minor & "." & App.Revision
End Sub
