VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptCategory 
   Bindings        =   "rptCategory.dsx":0000
   Caption         =   "System Reports"
   ClientHeight    =   9120
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   14025
   Icon            =   "rptCategory.dsx":0018
   MDIChild        =   -1  'True
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item12 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         EndProperty
         ForeColor       =   4210752
         Object.Caption         =   "Items by Categories"
      EndProperty
   EndProperty
   SectionCode1    =   2
...
With Rs
    rptCategory.Sections("ReportHeader").Controls("lblUserName").Caption = StrConv(.Fields!fname & " " & Left(.Fields!mname, 1) & ". " & .Fields!lname, vbProperCase)
End With
rptCategory.Sections("PageFooter").Controls("lblApp").Caption = App.ProductName & " v" & App.Major & "." & App.Minor & "." & App.Revision
End Sub

Private Sub DataReport_Terminate()
dtaGroups.conDb.Close
End Sub
